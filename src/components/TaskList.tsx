        ...
        <ul>
          {tasks.map((task) => (
            ...
            >
              ...
              <button
                className='bg-transparent text-zinc-400 dark:text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-900 hover:text-red-400 dark:hover:text-red-400 p-2 rounded-full transition'
