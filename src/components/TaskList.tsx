    ...
    <ul className='max-w-2xl w-full'>
      {tasks.map((task) => (
        ...
        >
          ...
          <button
            className='bg-transparent text-zinc-300 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-red-400 dark:hover:text-red-400 p-2 rounded-full transition'
